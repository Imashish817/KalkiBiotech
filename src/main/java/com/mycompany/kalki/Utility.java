...
public class Utility {
    ...
    public static final String Sep = "/" + new MongoDBCalls().getInvoiceDialog() + "/";
    public static final String RSep = "/" + new MongoDBCalls().getInvoiceDialog() + "/R/";
    public static final String FileLocation = "C:/Kalki/";
    ...
    public static String longDateToLocalDate(Long longDate) {
